  ...
  const handleCreateEvent = async () => {
    ...
    try {
      const createdEvent = await createEvent({
        ...
        description:
          eventDescription.trim() || "Evento registrado desde la vista web",
    ...
    <SafeAreaView className="flex-1 bg-[#dce9f5]">
      <View className="px-4 pb-3 pt-3">
        ...
        <Text className="mt-1 text-sm text-[#4d648a]">
          Mapa OpenStreetMap para crear y monitorear eventos y puntos de
          recogida.
        </Text>
      ...
      {isCreateEventOpen ? (
        ...
        >
          <View className="rounded-3xl border border-[#d5e3fb] bg-white px-5 py-5">
            ...
            <Text className="mb-2 mt-4 text-sm font-semibold text-[#233b61]">
              Nombre Del Evento
            </Text>
            <TextInput
