  ...
  return (
    ...
    >
      ...
      <View style={{ padding: 12 }}>
        <Text
          style={{ fontSize: 15, fontWeight: "800", color: "#111f3c" }}
          numberOfLines={1}
        >
          {point.name}
        </Text>
        ...
        {event ? (
          <Text
            style={{ fontSize: 11, color: "#1e73fa", marginTop: 4 }}
            numberOfLines={1}
          >
            {event.name}
          </Text>
...
function ShipmentRow({ shipment }: Readonly<{ shipment: Shipment }>) {
  ...
  return (
    ...
    >
      <View
        style={{ backgroundColor: "#e8f3ff", borderRadius: 16, padding: 14 }}
      >
      ...
      <View style={{ flex: 1, marginLeft: 14 }}>
        ...
        <Text style={{ fontSize: 13, color: "#9ca3af", marginTop: 2 }}>
          Entrega Estimada: {estimatedTime}
        </Text>
      </View>
...
function VolunteerCard({ volunteer }: Readonly<{ volunteer: UserSummary }>) {
  ...
  return (
    ...
    >
      ...
      >
        <Text style={{ color: "#1e73fa", fontSize: 13, fontWeight: "700" }}>
          Asignar
        </Text>
      </Pressable>
    </View>
...
export function OrganizerLogisticsScreen() {
  ...
  const [pickupSubmitError, setPickupSubmitError] = useState<string | null>(
    null,
  );
      ...
      >
                ...
                >
                  <Text
                    style={{
                      fontSize: 12,
                      fontWeight: "700",
                      color: isSelected ? "#1f4fb6" : "#4a6083",
                    }}
                  >
                    {eventItem.name}
                  </Text>
        ...
        >
          <Pressable
            ...
            onPress={onCancel}
          >
            <Text style={{ fontWeight: "700", color: "#3a5176" }}>
              Cancelar
            </Text>
          </Pressable>
          <Pressable
            style={{
              ...
              paddingHorizontal: 22,
              paddingVertical: 12,
              backgroundColor: canCreatePickup ? "#1f5fe0" : "#9db8e5",
            }}
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      setVolunteers(
        usersResponse.data.filter((user) => user.role === "volunteer"),
      );
      setSelectedEventId(
        (current) => current ?? eventsResponse.data[0]?.id ?? null,
      );
    } catch (error) {
      setLoadError(
        `No fue posible cargar logistica. ${getErrorMessage(error)}`,
      );
    } finally {
      setIsLoading(false);
    }
  ...
  const handleCreatePickupPoint = async () => {
    ...
    try {
      ...
      setPickupSubmitError(
        `No se pudo crear el punto. ${getErrorMessage(error)}`,
      );
    } finally {
      ...
      >
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <Text style={{ fontSize: 24, fontWeight: "900", color: "#111f3c" }}>
              LastMile
            </Text>
          </View>
          <Pressable
        ...
        <View style={{ marginBottom: 24 }}>
          ...
          >
            ...
            <Pressable onPress={loadData}>
              <Text
                style={{ fontSize: 15, fontWeight: "700", color: "#1e73fa" }}
              >
                Ver todos
              </Text>
            </Pressable>
